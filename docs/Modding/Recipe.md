...
**新配方**(金属冶炼)  
![粉碎锇矿石新烧制配方](./img/ingot_osmium_compat_mekanism_new.png "粉碎锇矿石新烧制配方")

## 锇的量产
**新增配方**(无序合成)  
![污浊锇粉合成配方](./img/osmium_duplicate.png "污浊锇粉合成配方")  

## TaCZ枪械工作台的合成
**原配方**(有序合成)  
![TaCZ枪械工作台原配方](./img/gun_smith_table_origin.png "TaCZ枪械工作台原配方")  
**新配方**(有序合成)  
![TaCZ枪械工作台新配方](./img/gun_smith_table_new.png "TaCZ枪械工作台新配方")  

## 晶体管
**新配方**(有序合成)  
![晶体管新配方](./img/transistor_new.png "晶体管新配方")  

## 基础物流管道
**原配方**(有序合成)  
![基础物流管道原配方](./img/basic_logistical_transporter_origin.png "基础物流管道原配方")  
**新配方**(有序合成)  
![基础物流管道新配方](./img/basic_logistical_transporter_new.png "基础物流管道新配方")  
